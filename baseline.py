...
class bc_LSTM:
    ...
    def __init__(self, args):
        ...
        self.PATH = r"C:\Users\saury\PycharmProjects\FacialMMT\data\models/{}_weights_{}.hdf5".format(args.modality, self.classification_mode.lower())
        self.OUTPUT_PATH = r"C:\Users\saury\PycharmProjects\FacialMMT\data\pickles/{}_{}.pkl".format(args.modality, self.classification_mode.lower())
    ...
    def get_text_model(self):
        ...
        conv_0 = Conv2D(self.num_filters, kernel_size=(self.filter_sizes[0], self.embedding_dim), padding='valid',
                        kernel_initializer='normal', activation='relu')
        conv_1 = Conv2D(self.num_filters, kernel_size=(self.filter_sizes[1], self.embedding_dim), padding='valid',
                        kernel_initializer='normal', activation='relu')
        conv_2 = Conv2D(self.num_filters, kernel_size=(self.filter_sizes[2], self.embedding_dim), padding='valid',
                        kernel_initializer='normal', activation='relu')
        maxpool_0 = MaxPool2D(pool_size=(sentence_length - self.filter_sizes[0] + 1, 1), strides=(1, 1),
                              padding='valid')
        maxpool_1 = MaxPool2D(pool_size=(sentence_length - self.filter_sizes[1] + 1, 1), strides=(1, 1),
                              padding='valid')
        maxpool_2 = MaxPool2D(pool_size=(sentence_length - self.filter_sizes[2] + 1, 1), strides=(1, 1),
                              padding='valid')
        ...
        for ind in range(self.sequence_length):
            local_input = Lambda(slicer, output_shape=slicer_output_shape, arguments={"index": ind})(
            ...
            concatenated_tensor = Concatenate(axis=1)(
                [maxpool_0(conv_0(reshape)), maxpool_1(conv_1(reshape)), maxpool_2(conv_2(reshape))])
...
if __name__ == "__main__":
    ...
    for directory in [r"C:\Users\saury\PycharmProjects\FacialMMT\data\pickles", r"C:\Users\saury\PycharmProjects\FacialMMT\data\models"]:
