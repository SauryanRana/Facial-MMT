...
class Dataloader:
    ...
    def __init__(self, mode=None):
        ...
        """
        x = pickle.load(open(r"C:\Users\saury\PycharmProjects\FacialMMT\pickles\\data_{}.p".format(self.MODE.lower()),"rb"))
    ...
    def load_audio_data(self, ):
        ...
        AUDIO_PATH = r"C:\Users\saury\PycharmProjects\FacialMMT\pickles\\audio_embeddings_feature_selection_{}.pkl".format(self.MODE.lower())
    ...
    def load_bimodal_data(self,):
        ...
        TEXT_UNIMODAL = r"C:\Users\saury\PycharmProjects\FacialMMT\pickles\\text_{}.pkl".format(self.MODE.lower())
        AUDIO_UNIMODAL = r"C:\Users\saury\PycharmProjects\FacialMMT\pickles\\audio_{}.pkl".format(self.MODE.lower())
